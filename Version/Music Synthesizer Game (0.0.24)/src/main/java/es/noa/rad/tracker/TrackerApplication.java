...
public final class TrackerApplication {
  ...
  private static JPanel buildToolbar(final TrackerPanel tracker,
    ...
    // Guardar / Cargar
    final JButton saveBtn = makeButton("\uD83D\uDCBE Guardar",
        new Color(40, 100, 160), new Color(55, 130, 200));
    saveBtn.setPreferredSize(new Dimension(100, 28));
    saveBtn.addActionListener(e ->
        MelodyFile.save(frame, tracker, sequencer));

    final JButton loadBtn = makeButton("\uD83D\uDCC2 Cargar",
        new Color(40, 100, 160), new Color(55, 130, 200));
    ...
    loadBtn.addActionListener(e -> {
      ...
      MelodyFile.load(frame, tracker, sequencer,
          newBpm -> {
            bpmLbl.setText("BPM: " + newBpm);
          },
