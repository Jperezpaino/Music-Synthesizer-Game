...
public final class MelodyFile {
   ...
   * @return el File donde se guardo, o {@code null} si el usuario cancelo
   */
  public static File saveAs(final JFrame parent,
    ...
    if (writeToFile(file, tracker, sequencer, parent)) {
      return file;
    }
    return null;
  }
  ...
  // -------------------------------------------------------------------------
  // Guardar (sobre fichero existente, sin dialogo)
  // -------------------------------------------------------------------------

  /**
   * Guarda la melodia directamente en {@code file}, sin mostrar dialogo.
   *
   * @param file      destino donde escribir
   * @param tracker   panel con los datos de la melodia
   * @param sequencer motor del sequencer
   * @param parent    ventana padre para mensajes de error
  ...
  public static boolean saveToFile(final File file,
                                   ...
                                   final SequencerEngine sequencer,
                                   final JFrame parent) {
    return writeToFile(file, tracker, sequencer, parent);
  }
