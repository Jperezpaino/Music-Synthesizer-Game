...
public final class TrackerApplication {
  ...
  private static JMenuBar buildMenuBar(final TrackerPanel tracker,
    ...
    // -- Abrir (Ctrl+O)
    final JMenuItem openItem = new JMenuItem("Abrir...");
    ...
    final JMenuItem saveAsItem = new JMenuItem("Guardar como...");
    ...
    // -- Exportar WAV (Ctrl+E)
    final JMenuItem exportItem = new JMenuItem("Exportar WAV...");
    ...
    final JMenuItem closeItem = new JMenuItem("Cerrar");
