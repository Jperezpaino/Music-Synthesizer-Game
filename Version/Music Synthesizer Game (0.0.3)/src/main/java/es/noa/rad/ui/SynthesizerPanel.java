 ...
 *
 * <p>Combina el panel de controles (arriba) y el teclado piano (centro),
 * usando un fondo oscuro coherente con el diseño general.</p>
 */
public final class SynthesizerPanel extends JPanel {
  ...
  public SynthesizerPanel(final SoundEngine soundEngine) {
    ...
    // Vincular el control de octava con el teclado
